## gps_umd (jazzy) - 2.1.0-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy gps_umd --override-release-repository-push-url git@github.com:revyos-ros/gps_umd-release.git --edit` on `Wed, 18 Jun 2025 06:20:59 -0000`
...
## gps_umd (humble) - 2.0.4-2

The packages in the `gps_umd` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble gps_umd --override-release-repository-push-url git@github.com:revyos-ros/gps_umd-release.git` on `Mon, 16 Jun 2025 04:42:46 -0000`
...
## gps_umd (iron) - 2.0.4-1

The packages in the `gps_umd` repository were released into the `iron` distro by running `/usr/bin/bloom-release --edit --rosdistro iron gps_umd` on `Tue, 07 May 2024 14:13:40 -0000`
...
## gps_umd (humble) - 2.0.4-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Tue, 07 May 2024 14:09:46 -0000`
...
## gps_umd (rolling) - 2.0.4-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Tue, 07 May 2024 14:06:02 -0000`
